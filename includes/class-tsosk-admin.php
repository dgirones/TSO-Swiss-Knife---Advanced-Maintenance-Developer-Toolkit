...
class TSOSK_Admin {
	...
	public function enqueue_assets( string $hook ): void {
		...
		wp_localize_script(
			...
			array(
				...
				'i18n'            => array(
					'confirm_delete'  => __( 'Are you sure you want to delete this item?', 'tso-swiss-knife' ),
					'confirm_purge'   => __( 'Purge all items?', 'tso-swiss-knife' ),
					'running'         => __( 'Running…', 'tso-swiss-knife' ),
					'done'            => __( 'Done!', 'tso-swiss-knife' ),
					'error'           => __( 'Error. Please try again.', 'tso-swiss-knife' ),
					'confirm_sandbox' => __( 'This will reload the page with the selected plugins. Continue?', 'tso-swiss-knife' ),
					'clear_pause'     => __( 'Clear pause', 'tso-swiss-knife' ),
					'save_redirect'   => __( 'Save Redirect', 'tso-swiss-knife' ),
					'update_redirect' => __( 'Update Redirect', 'tso-swiss-knife' ),
					'debug_log_ready' => __( 'WP_DEBUG and WP_DEBUG_LOG are selected. Save settings to activate debug.log.', 'tso-swiss-knife' ),
					'run'             => __( 'Run', 'tso-swiss-knife' ),
					'edit'            => __( 'Edit', 'tso-swiss-knife' ),
					'save_schedule'   => __( 'Save schedule', 'tso-swiss-knife' ),
					'cron_rescheduled'=> __( 'Event rescheduled.', 'tso-swiss-knife' ),
					'purge_expired'   => __( 'Purge Expired', 'tso-swiss-knife' ),
					'purge_all'       => __( 'Purge All', 'tso-swiss-knife' ),
					'soft_flush'      => __( 'Soft Flush', 'tso-swiss-knife' ),
					'hard_flush'      => __( 'Hard Flush', 'tso-swiss-knife' ),
					'flush_cache'     => __( 'Flush Object Cache', 'tso-swiss-knife' ),
					'on'              => __( 'ON', 'tso-swiss-knife' ),
					'off'             => __( 'OFF', 'tso-swiss-knife' ),
					'enable'          => __( 'Enable', 'tso-swiss-knife' ),
					'disable'         => __( 'Disable', 'tso-swiss-knife' ),
					'apply_sandbox'   => __( 'Apply Sandbox', 'tso-swiss-knife' ),
					'reset_sandbox'   => __( 'Reset Sandbox', 'tso-swiss-knife' ),
					'errors'          => __( 'Errors', 'tso-swiss-knife' ),
					'clear_404_log'   => __( 'Clear 404 Log', 'tso-swiss-knife' ),
					'save_alerts'     => __( 'Save Alert Settings', 'tso-swiss-knife' ),
					'close_sessions'  => __( 'Close Sessions', 'tso-swiss-knife' ),
					'close_all_sessions' => __( 'Close all sessions', 'tso-swiss-knife' ),
					'force_pwd_confirm' => __( 'Force this user to change their password on next login and close all sessions?', 'tso-swiss-knife' ),
					'users_select_one'  => __( 'Select at least one user.', 'tso-swiss-knife' ),
					'users_bulk_confirm'=> __( 'Apply bulk action to selected inactive users?', 'tso-swiss-knife' ),
					'dangerous_cap'     => __( 'High risk', 'tso-swiss-knife' ),
					'roles_only_a'      => __( 'Only in role A', 'tso-swiss-knife' ),
					'roles_only_b'      => __( 'Only in role B', 'tso-swiss-knife' ),
					'roles_both'        => __( 'In both roles', 'tso-swiss-knife' ),
					'roles_admin_readonly' => __( 'Administrator capabilities loaded (read-only).', 'tso-swiss-knife' ),
					'regenerate'           => __( 'Regenerate Thumbnails', 'tso-swiss-knife' ),
					'media_footprint_scan' => __( 'Scan uploads folder', 'tso-swiss-knife' ),
					'image_sizes_scan'     => __( 'Run image sizes audit', 'tso-swiss-knife' ),
					'image_sizes_save'     => __( 'Save image size settings', 'tso-swiss-knife' ),
					'send_test'       => __( 'Send Test', 'tso-swiss-knife' ),
					'fi_connecting'   => __( 'Connecting to WordPress.org API…', 'tso-swiss-knife' ),
					'fi_clean'        => __( 'All core files are intact.', 'tso-swiss-knife' ),
					'fi_issues'       => __( 'issue(s) found — review the results below.', 'tso-swiss-knife' ),
					'fi_no_html'      => __( 'Scan complete.', 'tso-swiss-knife' ),
					'fi_ignore'       => __( 'Ignore', 'tso-swiss-knife' ),
					'fi_remove'       => __( 'Remove', 'tso-swiss-knife' ),
					'fi_timeout'      => __( 'Scan timed out. The server took too long to respond. Try Force Re-scan or check PHP max_execution_time.', 'tso-swiss-knife' ),
					'lp_unlock'       => __( 'Unlock', 'tso-swiss-knife' ),
					'lp_reset'        => __( 'Reset', 'tso-swiss-knife' ),
					'lp_unlock_all'   => __( 'Unlock All', 'tso-swiss-knife' ),
					'lp_unlock_all_confirm' => __( 'Unlock all currently locked IP addresses?', 'tso-swiss-knife' ),
					'lp_clear_log_confirm'  => __( 'Clear the entire lockout log? This cannot be undone.', 'tso-swiss-knife' ),
					'lp_clear_log'    => __( 'Clear Log', 'tso-swiss-knife' ),
					'lp_generate'     => __( 'Generate', 'tso-swiss-knife' ),
					'oe_edit'         => __( 'Edit', 'tso-swiss-knife' ),
					'oe_save'         => __( 'Save Option', 'tso-swiss-knife' ),
					'oe_delete'       => __( 'Delete', 'tso-swiss-knife' ),
					'oe_add'          => __( 'Add Option', 'tso-swiss-knife' ),
					'oe_protected'    => __( 'Protected', 'tso-swiss-knife' ),
					'oe_view'         => __( 'View', 'tso-swiss-knife' ),
					'oe_show_protected' => __( 'Show protected options', 'tso-swiss-knife' ),
					'oe_hide_protected' => __( 'Hide protected options', 'tso-swiss-knife' ),
					'oe_add_hint_text'  => __( 'Plain text value.', 'tso-swiss-knife' ),
					'oe_add_hint_integer' => __( 'Whole number only, for example: 0 or 42.', 'tso-swiss-knife' ),
					'oe_add_hint_json'  => __( 'Valid JSON object or array.', 'tso-swiss-knife' ),
					'oe_add_hint_serialized' => __( 'Valid PHP serialized string.', 'tso-swiss-knife' ),
					'oe_raw'          => __( 'Show raw value', 'tso-swiss-knife' ),
					'oe_pretty'       => __( 'Show formatted value', 'tso-swiss-knife' ),
					'oe_confirm_del'  => __( 'Delete this option permanently? This cannot be undone.', 'tso-swiss-knife' ),
					'oe_no_results'   => __( 'No options found.', 'tso-swiss-knife' ),
					'oe_type_ser'     => __( 'Serialized PHP — edit only if you know PHP serialization syntax.', 'tso-swiss-knife' ),
					'oe_type_json'    => __( 'JSON — must remain valid JSON after editing.', 'tso-swiss-knife' ),
					'oe_page'         => __( 'Page', 'tso-swiss-knife' ),
					'oe_of'           => __( 'of', 'tso-swiss-knife' ),
					'oe_options'      => __( 'options', 'tso-swiss-knife' ),
					'sm_rename'       => __( 'Rename', 'tso-swiss-knife' ),
					'sm_save_slug'    => __( 'Save New Slug', 'tso-swiss-knife' ),
					'sm_no_posts'     => __( 'No posts found.', 'tso-swiss-knife' ),
					'sm_chars'        => __( 'characters', 'tso-swiss-knife' ),
					'sm_bulk_fix'     => __( 'Bulk Fix Selected', 'tso-swiss-knife' ),
					'sm_bulk_preview_title' => __( 'Bulk slug fix preview', 'tso-swiss-knife' ),
					'sm_bulk_confirm_btn' => __( 'Confirm changes', 'tso-swiss-knife' ),
					'sm_bulk_col_skipped' => __( 'Skipped', 'tso-swiss-knife' ),
					'sm_bulk_col_reason'  => __( 'Reason', 'tso-swiss-knife' ),
					'sm_bulk_confirm' => __( 'Truncate the selected slugs and create redirects where enabled? This changes permalinks immediately.', 'tso-swiss-knife' ),
					'sm_bulk_col_post' => __( 'Post', 'tso-swiss-knife' ),
					'sm_bulk_col_before' => __( 'Before', 'tso-swiss-knife' ),
					'sm_bulk_col_after' => __( 'After', 'tso-swiss-knife' ),
					'sm_total_items'  => __( 'items', 'tso-swiss-knife' ),
					'ca_remove_sc_confirm'  => __( 'Remove this broken shortcode from the post content?', 'tso-swiss-knife' ),
					'ca_remove_all_confirm' => __( 'Remove all broken shortcodes from this post?', 'tso-swiss-knife' ),
					'asched_cancel_confirm' => __( 'Cancel this scheduled action?', 'tso-swiss-knife' ),
					'sm_redirect_note' => __( 'Redirect will be added to TSO Swiss Knife Redirects automatically.', 'tso-swiss-knife' ),
					'sq_clear_confirm' => __( 'Clear the entire slow query log? This cannot be undone.', 'tso-swiss-knife' ),
					'sq_delete_confirm'=> __( 'Delete this entry?', 'tso-swiss-knife' ),
					'sq_no_results'    => __( 'No slow queries match your search.', 'tso-swiss-knife' ),
					'sq_slow'          => __( 'slow', 'tso-swiss-knife' ),
					'sq_page'          => __( 'Page', 'tso-swiss-knife' ),
					'sq_of'            => __( 'of', 'tso-swiss-knife' ),
					'sr_preview_none'  => __( 'No matches found for the search term in the selected tables.', 'tso-swiss-knife' ),
					'sr_confirm_exec'  => __( 'This will modify the database. Have you made a backup? Click OK to proceed.', 'tso-swiss-knife' ),
					'sr_no_tables'     => __( 'Select at least one table.', 'tso-swiss-knife' ),
					'sr_empty_search'  => __( 'Enter a search term.', 'tso-swiss-knife' ),
					'sr_stale_preview' => __( 'Settings changed after preview. Run Preview again before executing.', 'tso-swiss-knife' ),
					'sr_preview_btn'   => __( 'Preview changes', 'tso-swiss-knife' ),
					'sr_tables'        => __( 'tables', 'tso-swiss-knife' ),
					'sr_confirm_hint'  => __( 'Review below and click "Execute replace" to commit changes.', 'tso-swiss-knife' ),
					'snapshot_confirm_import' => __( 'Import will overwrite settings for the sections in this snapshot. Continue?', 'tso-swiss-knife' ),
					'snapshot_no_sections'    => __( 'Select at least one section to export.', 'tso-swiss-knife' ),
					'sr_more'          => __( 'more rows', 'tso-swiss-knife' ),
					'sr_pk'            => __( 'ID', 'tso-swiss-knife' ),
					'sr_execute_btn'   => __( 'Execute replace', 'tso-swiss-knife' ),
					'history_clear'    => __( 'Clear all activity history? This cannot be undone.', 'tso-swiss-knife' ),
					'delete'           => __( 'Delete', 'tso-swiss-knife' ),
					'loading'          => __( 'Loading…', 'tso-swiss-knife' ),
					'no_title'         => __( '(no title)', 'tso-swiss-knife' ),
					'sr_rows'          => __( 'rows', 'tso-swiss-knife' ),
					'sr_matches'       => __( 'matches', 'tso-swiss-knife' ),
					'previous'        => __( 'Previous', 'tso-swiss-knife' ),
					'next'            => __( 'Next', 'tso-swiss-knife' ),
					'save'            => __( 'Save Settings', 'tso-swiss-knife' ),
					'sidebar_save'    => __( 'Save', 'tso-swiss-knife' ),
					'sidebar_hide'    => __( 'Hide', 'tso-swiss-knife' ),
					'sidebar_show'    => __( 'Show', 'tso-swiss-knife' ),
					'sidebar_reset'   => __( 'Reset', 'tso-swiss-knife' ),
					'sidebar_cancel'  => __( 'Cancel', 'tso-swiss-knife' ),
					/* translators: %s: sidebar tab label. */
					'sidebar_drop_before' => __( 'Drop above: %s', 'tso-swiss-knife' ),
					/* translators: %s: sidebar tab label. */
					'sidebar_drop_after'  => __( 'Drop below: %s', 'tso-swiss-knife' ),
					'sidebar_drop_end'    => __( 'Drop at end of list', 'tso-swiss-knife' ),
					'favorites_remove'    => __( 'Remove from favorites', 'tso-swiss-knife' ),
					'favorites_add'       => __( 'Add to favorites', 'tso-swiss-knife' ),
					'cancel'              => __( 'Cancel', 'tso-swiss-knife' ),
					'no_matches'          => __( 'No items found.', 'tso-swiss-knife' ),
					'search_placeholder' => __( 'Search… (Ctrl+K)', 'tso-swiss-knife' ),
					'search_no_results'  => __( 'No matching tools.', 'tso-swiss-knife' ),
					'search_hint'        => __( 'Type to find a tab, then press Enter or click a result.', 'tso-swiss-knife' ),
					'site_status_label'  => __( 'Site status', 'tso-swiss-knife' ),
					'dev_mode_enable'    => __( 'Enable dev mode', 'tso-swiss-knife' ),
					'dev_mode_disable'   => __( 'Disable dev mode', 'tso-swiss-knife' ),
					'custom_404_active'  => __( 'Custom 404 active', 'tso-swiss-knife' ),
					'custom_404_default' => __( 'Using theme default 404', 'tso-swiss-knife' ),
					'custom_404_select_preview' => __( 'Select a published page to preview.', 'tso-swiss-knife' ),
					'am_reset_confirm'   => __( 'Reset the sidebar menu to WordPress defaults?', 'tso-swiss-knife' ),
					'maint_select_logo'  => __( 'Select logo', 'tso-swiss-knife' ),
					'maint_use_logo'     => __( 'Use this image', 'tso-swiss-knife' ),
					'ol_preview_loaded'   => __( 'Preview loaded.', 'tso-swiss-knife' ),
					'expired'         => __( 'Expired', 'tso-swiss-knife' ),
					'wpconfig_confirm' => __( 'This will modify wp-config.php directly. A backup is recommended before proceeding. Continue?', 'tso-swiss-knife' ),
					'wpconfig_set'    => __( 'Set in wp-config.php', 'tso-swiss-knife' ),
					'wpconfig_done'   => __( '✓ Saved in wp-config.php', 'tso-swiss-knife' ),
					/* translators: %s: log file label shown in the confirmation dialog. */
					'debug_empty_log_confirm' => __( 'Empty "%s"? All log entries will be deleted but the file will remain on disk. This cannot be undone.', 'tso-swiss-knife' ),
					/* translators: %s: log file label shown in the confirmation dialog. */
					'debug_shrink_log_confirm' => __( 'Keep only the last 500 lines of %s? Older lines will be archived.', 'tso-swiss-knife' ),
				),
			)
		);
	}
	...
	public function action_links( array $links ): array {
		array_unshift(
			...
			. esc_html__( 'Open', 'tso-swiss-knife' ) . '</a>'
		);
		return $links;
	}
	...
	public function ajax_save_order(): void {
		...
		wp_send_json_success( __( 'Sidebar layout saved.', 'tso-swiss-knife' ) );
	}
	...
	public function ajax_reset_order(): void {
		...
		wp_send_json_success( __( 'Sidebar reset to default order.', 'tso-swiss-knife' ) );
	}
	...
	private function get_tab_group_labels(): array {
		return array(
			'profiles'    => __( 'Profiles & config', 'tso-swiss-knife' ),
			'performance' => __( 'Performance', 'tso-swiss-knife' ),
			'database'    => __( 'Database', 'tso-swiss-knife' ),
			'security'    => __( 'Security', 'tso-swiss-knife' ),
			'content'     => __( 'Content & URLs', 'tso-swiss-knife' ),
			'development' => __( 'Development', 'tso-swiss-knife' ),
			'site'        => __( 'Site & tools', 'tso-swiss-knife' ),
		);
	}
	...
	private function get_tabs(): array {
		...
		$tabs      = array(
			'history' => array(
				'label' => __( 'Activity History', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-backup',
				'class' => 'TSOSK_Mod_History',
			),
			'hidden-profiles' => array(
				'label' => __( 'Hidden WordPress Profiles', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-admin-settings',
				'class' => 'TSOSK_Mod_Hidden_Profiles',
			),
			'cron'       => array(
				'label' => __( 'Cron Manager', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-clock',
				'class' => 'TSOSK_Mod_Cron',
			),
			'action-scheduler' => array(
				'label' => __( 'Action Scheduler', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-list-view',
				'class' => 'TSOSK_Mod_Action_Scheduler',
			),
			'debug'      => array(
				'label' => __( 'Debug Mode', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-admin-generic',
				'class' => 'TSOSK_Mod_Debug',
			),
			'options-editor' => array(
				'label' => __( 'Options Editor', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-edit',
				'class' => 'TSOSK_Mod_Options_Editor',
			),
			'meta-editor' => array(
				'label' => __( 'Meta Editor', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-id',
				'class' => 'TSOSK_Mod_Meta_Editor',
			),
			'option-library' => array(
				'label' => __( 'Option Library', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-book',
				'class' => 'TSOSK_Mod_Option_Library',
			),
			'site-snapshot' => array(
				'label' => __( 'Export/Import TSO Configuration', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-backup',
				'class' => 'TSOSK_Mod_Site_Snapshot',
			),
			'options'    => array(
				'label' => __( 'TSO Link Inspector', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-admin-links',
				'class' => 'TSOSK_Mod_Options',
			),
			'transients' => array(
				'label' => __( 'Transients', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-database-remove',
				'class' => 'TSOSK_Mod_Transients',
			),
			'constants'  => array(
				'label' => __( 'WP Constants', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-editor-code',
				'class' => 'TSOSK_Mod_Constants',
			),
			'internals'  => array(
				'label' => __( 'WP Internals', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-admin-tools',
				'class' => 'TSOSK_Mod_Internals',
			),
			'rest-api'   => array(
				'label' => __( 'REST API', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-networking',
				'class' => 'TSOSK_Mod_Rest_Api',
			),
			'heartbeat'  => array(
				'label' => __( 'Heartbeat', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-heart',
				'class' => 'TSOSK_Mod_Heartbeat',
			),
			'update-manager' => array(
				'label' => __( 'Update Manager', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-update',
				'class' => 'TSOSK_Mod_Update_Manager',
			),
			'database'   => array(
				'label' => __( 'TSO Options & Tables Cleaner', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-database',
				'class' => 'TSOSK_Mod_Database',
			),
			'slow-queries' => array(
				'label' => __( 'Slow Query Monitor', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-clock',
				'class' => 'TSOSK_Mod_Slow_Queries',
			),
			'search-replace' => array(
				'label' => __( 'Search & Replace', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-search',
				'class' => 'TSOSK_Mod_Search_Replace',
			),
			'hooks'      => array(
				'label' => __( 'Hooks Inspector', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-filter',
				'class' => 'TSOSK_Mod_Hooks',
			),
			'rewrite'    => array(
				'label' => __( 'Rewrite Rules', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-admin-links',
				'class' => 'TSOSK_Mod_Rewrite',
			),
			'server-files' => array(
				'label' => __( 'Server Files Review', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-media-code',
				'class' => 'TSOSK_Mod_Server_Files',
			),
			'redirects'  => array(
				'label' => __( 'Redirects', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-randomize',
				'class' => 'TSOSK_Mod_Redirects',
			),
			'custom-404' => array(
				'label' => __( 'Custom 404 Page', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-warning',
				'class' => 'TSOSK_Mod_Custom_404',
			),
			'slug-manager' => array(
				'label' => __( 'Slug Manager', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-admin-links',
				'class' => 'TSOSK_Mod_Slug_Manager',
			),
			'health'     => array(
				'label' => __( 'Health Report', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-chart-area',
				'class' => 'TSOSK_Mod_Health',
			),
			'admin-menu' => array(
				'label' => __( 'Reorder & Hide Sidebar', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-menu',
				'class' => 'TSOSK_Mod_Admin_Menu',
			),
			'users'      => array(
				'label' => __( 'Users & Sessions', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-groups',
				'class' => 'TSOSK_Mod_Users',
			),
			'roles'      => array(
				'label' => __( 'Roles & Capabilities', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-admin-users',
				'class' => 'TSOSK_Mod_Roles',
			),
			'media-cleaner' => array(
				'label' => __( 'Media Cleaner', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-format-gallery',
				'class' => 'TSOSK_Mod_Media_Cleaner',
			),
			'media-footprint' => array(
				'label' => __( 'Uploads Disk Footprint', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-chart-pie',
				'class' => 'TSOSK_Mod_Media_Footprint',
			),
			'image-sizes-audit' => array(
				'label' => __( 'Image Sizes Audit', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-image-crop',
				'class' => 'TSOSK_Mod_Image_Sizes_Audit',
			),
			'security'   => array(
				'label' => __( 'Security Review', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-shield-alt',
				'class' => 'TSOSK_Mod_Security',
			),
			'file-integrity' => array(
				'label' => __( 'Core File Integrity', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-media-code',
				'class' => 'TSOSK_Mod_File_Integrity',
			),
			'login-protect' => array(
				'label' => __( 'Login Protection', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-lock',
				'class' => 'TSOSK_Mod_Login_Protect',
			),
			'comment-antispam' => array(
				'label' => __( 'Comment Anti-Spam', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-format-chat',
				'class' => 'TSOSK_Mod_Comment_Antispam',
			),
			'email'      => array(
				'label' => __( 'Email Diagnostics', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-email-alt',
				'class' => 'TSOSK_Mod_Email',
			),
			'footprint'  => array(
				'label' => __( 'Plugin Footprint', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-screenoptions',
				'class' => 'TSOSK_Mod_Footprint',
			),
			'content-audit' => array(
				'label' => __( 'Content Audit', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-media-document',
				'class' => 'TSOSK_Mod_Content_Audit',
			),
			'maintenance' => array(
				'label' => __( 'Maintenance Mode', 'tso-swiss-knife' ),
				'icon'  => 'dashicons-visibility',
				'class' => 'TSOSK_Mod_Maintenance',
			),
			'sandbox'    => array(
				'label' => __( 'Plugin Sandbox', 'tso-swiss-knife' ),
	...
	private function render_sidebar_nav_row( string $slug, array $tab, string $base_url, string $current, bool $favorites = false, bool $is_hidden = false ): void {
		...
		<div class="<?php echo esc_attr( $row_class ); ?>"
			...
			<button type="button" class="tsosk-remove-fav"
			        data-slug="<?php echo esc_attr( $slug ); ?>"
			        title="<?php esc_attr_e( 'Remove from favorites', 'tso-swiss-knife' ); ?>">✕</button>
			<?php else : ?>
			<button type="button" class="tsosk-hide-tab"
			        data-slug="<?php echo esc_attr( $slug ); ?>"
			        title="<?php echo $is_hidden ? esc_attr__( 'Show', 'tso-swiss-knife' ) : esc_attr__( 'Hide', 'tso-swiss-knife' ); ?>">
				<?php echo $is_hidden ? '＋' : '✕'; ?>
			</button>
			<?php endif; ?>
		</div>
	...
	private function render_global_search(): void {
		...
		<div class="tsosk-global-search" id="tsosk-global-search">
			<label class="screen-reader-text" for="tsosk-global-search-input">
				<?php esc_html_e( 'Search tools', 'tso-swiss-knife' ); ?>
			</label>
			<span class="dashicons dashicons-search" aria-hidden="true"></span>
			<input type="search" id="tsosk-global-search-input" class="tsosk-global-search-input"
			       autocomplete="off" spellcheck="false"
			       title="<?php esc_attr_e( 'Search tools (Ctrl+K)', 'tso-swiss-knife' ); ?>"
			       placeholder="<?php esc_attr_e( 'Search… (Ctrl+K)', 'tso-swiss-knife' ); ?>">
	...
	private function render_site_status_bar( string $base_url, string $current_tab = '' ): void {
		...
		<div class="tsosk-site-status-bar" id="tsosk-site-status-bar">
			<span class="tsosk-site-status-label"><?php esc_html_e( 'Site status', 'tso-swiss-knife' ); ?>:</span>
			<?php if ( empty( $badges ) ) : ?>
				<span class="tsosk-site-status-ok"><?php esc_html_e( 'No special modes active', 'tso-swiss-knife' ); ?></span>
			<?php else : ?>
				...
				<span class="tsosk-site-status-actions">
					<?php if ( TSOSK_Site_Status::is_developer_mode_active() ) : ?>
						<a href="<?php echo esc_url( add_query_arg( 'tab', 'debug', $base_url ) ); ?>" class="tsosk-site-status-badge tsosk-site-status-warn">
							<?php esc_html_e( 'Developer mode', 'tso-swiss-knife' ); ?>
						</a>
					<?php elseif ( 'debug' === $current_tab ) : ?>
						<button type="button" class="button button-small" id="tsosk-header-dev-mode-on"
						        title="<?php esc_attr_e( 'Enable WP_DEBUG, debug.log and SAVEQUERIES', 'tso-swiss-knife' ); ?>">
							<?php esc_html_e( 'Enable dev mode', 'tso-swiss-knife' ); ?>
						</button>
					<?php endif; ?>
				</span>
			<?php endif; ?>
	...
	public function render_page(): void {
		if ( ! current_user_can( 'manage_options' ) ) {
			wp_die( esc_html__( 'You do not have permission to access this page.', 'tso-swiss-knife' ) );
		}
		...
		<div class="wrap tsosk-wrap">
			<h1 class="tsosk-page-title">
				...
				<?php esc_html_e( 'TSO Swiss Knife', 'tso-swiss-knife' ); ?>
			...
			<button type="button" class="button tsosk-mobile-nav-toggle" id="tsosk-mobile-nav-toggle"
				...
				<?php esc_html_e( 'Tools menu', 'tso-swiss-knife' ); ?>
			</button>

			<!-- ── Favorites bar ── -->
			<?php $order_nonce = wp_create_nonce( 'tsosk_sidebar_order_nonce' ); ?>
			<nav class="tsosk-sidebar tsosk-sidebar-favorites" aria-label="<?php esc_attr_e( 'Favorite tools', 'tso-swiss-knife' ); ?>"
			     id="tsosk-sidebar-favorites"
			     data-nonce="<?php echo esc_attr( $order_nonce ); ?>">
				<h2 class="tsosk-favorites-title">
					<span class="dashicons dashicons-star-filled" aria-hidden="true"></span>
					<?php esc_html_e( 'Favorites', 'tso-swiss-knife' ); ?>
				</h2>
				<p class="tsosk-favorites-hint" id="tsosk-favorites-hint">
					<?php esc_html_e( 'Use Organise on the tools list, then drag tabs here.', 'tso-swiss-knife' ); ?>
				</p>
			...
			<div class="tsosk-layout">
				...
				<nav class="tsosk-sidebar tsosk-sidebar-tools" aria-label="<?php esc_attr_e( 'Plugin tools', 'tso-swiss-knife' ); ?>"
					...
					<div class="tsosk-sidebar-actions" id="tsosk-sidebar-actions">
						<button type="button" id="tsosk-sidebar-organise"
						        ...
						        title="<?php esc_attr_e( 'Organise sidebar', 'tso-swiss-knife' ); ?>">
							<span class="dashicons dashicons-menu" aria-hidden="true"></span>
							<span class="tsosk-nav-label"><?php esc_html_e( 'Organise', 'tso-swiss-knife' ); ?></span>
						</button>
					</div>
					...
					<div class="tsosk-sidebar-edit-bar" id="tsosk-sidebar-edit-bar" style="display:none;">
						<span class="tsosk-sidebar-edit-hint" id="tsosk-sidebar-edit-hint">
							<?php esc_html_e( 'Drag tabs to reorder and move them between categories, drag into Favorites, and reorder favorites. Click ✕ on a tool to hide it or on a favorite to remove it.', 'tso-swiss-knife' ); ?>
						</span>
						<div class="tsosk-sidebar-edit-btns">
							<button type="button" id="tsosk-sidebar-save" class="tsosk-sidebar-save-btn">
								<?php esc_html_e( 'Save', 'tso-swiss-knife' ); ?>
							</button>
							<button type="button" id="tsosk-sidebar-reset" class="tsosk-sidebar-reset-btn">
								<?php esc_html_e( 'Reset', 'tso-swiss-knife' ); ?>
							</button>
				...
				<div class="tsosk-content" role="main">
					...
					<div class="tsosk-tab-body">
						...
						if ( class_exists( $class ) && method_exists( $class, 'get_instance' ) ) {
							...
							echo '<p>' . esc_html__( 'Module not available.', 'tso-swiss-knife' ) . '</p>';
						}
						?>
					</div>
					</div>
	...
	private function render_language_switcher( string $base_url, string $current ): void {
		...
		?>
		<span class="tsosk-language-switcher" aria-label="<?php esc_attr_e( 'Plugin language', 'tso-swiss-knife' ); ?>">
